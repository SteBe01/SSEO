function [rr_t, vv_t, rrf, vvf] = TBP2(M, m, rr0, vv0, rr1, vv1, t, dt)
...
plot3(xLag1, 0, 0, '.', 'MarkerSize', 15, MarkerEdgeColor='y', DisplayName='Lagrange point L1'); % HandleVisibility='off',
hold on
